...
public class Fitness extends Cliente implements PlanFitness{

    //Constructor
    public Fitness(String nombre, int edad, String dpi, float peso, float altura, int metaPeso, String id, String idRutina, String idDieta, String sedeNombre, String password, String correo){
