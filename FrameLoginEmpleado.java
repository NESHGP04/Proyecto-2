...
public class FrameLoginEmpleado extends JFrame {

    int fieldWidth = 500;
    int fieldHeight = 50;

    public FrameLoginEmpleado(JFrame parentFrame) {
    ...
    private void initialize(JFrame parentFrame) {
        ...
        JLabel title = new JLabel("Iniciar sesion - Empleado", SwingConstants.CENTER);
